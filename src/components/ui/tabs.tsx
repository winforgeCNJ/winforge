...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          "no-visible-scrollbar relative flex w-full max-w-full flex-row items-start justify-start gap-6 overflow-auto sm:overflow-visible lg:mt-20 lg:flex-col",
          containerClassName,
        )}
      >
        {propTabs.map((tab, idx) => (
          <button
            ...
            className={cn(
              "relative rounded-full px-4 py-2 text-lg font-medium",
              tabClassName,
            )}
            style={{
