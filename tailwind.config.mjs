...
export default {
  ...
  plugins: [
    plugin(function ({ addBase, addComponents, addUtilities }) {
      ...
      addComponents({
        '.container': {
          '@apply max-w-[77.5rem] pt-4 mx-auto px-5 md:px-10 lg:px-12 xl:max-w-[87.5rem]':
            {},
        },
        '.h1': {
        ...
        '.h2': {
          '@apply font-medium text-[1.6rem] leading-[1.8rem] md:text-[1.75rem] md:leading-[1.75rem]  lg:text-[1.5rem] lg:leading-[1.8rem] xl:text-[2rem] xl:leading-[2.2rem]':
            {},
        },
        '.h3': {
